...
//exp1,exp2,exp3 函数调用的时候
typedef struct A_expList_ *A_expList;

//rocord声明的时候  id1 : id2 , id3 :id4
...
//rocord 定义的时候 id1=exp1,id2=exp2
typedef struct A_efield_ *A_efield;
typedef struct A_efieldList_ *A_efieldList;

//remark by xdl2007: actually there is no need to add 'AND' and 'OR' operation.
typedef enum {
	A_plusOp, 
	A_minusOp, 
	A_timesOp, 
...
struct A_field_ {
					...
					S_symbol name, typ; /*本身变量的名称和类型的名称*/
					A_pos pos; 
					bool escape;
				};
